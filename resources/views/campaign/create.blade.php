...
@section( 'content' )
    ...
    <form action="{{ route( 'campaign.save' ) }}" class="row mb-4 layout-spacing layout-top-spacing" id="campaign-form" method="post">
        ...
        <div class="col-xxl-9 col-xl-12 col-lg-12 col-md-12 col-sm-12">
            ...
            <div class="widget-content widget-content-area ecommerce-create-section">
                ...
                <div class="row mb-4">
                    <div class="col-sm-12">
                        <input type="text" class="form-control" id="name" name="name" placeholder="Nombre de campaña">
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 text-center">
                        <div class="switch form-switch-custom switch-inline form-switch-primary mt-4">
                            <input class="switch-input" type="checkbox" role="switch" id="active" name="active" checked>
                    ...
                    <div class="widget-content widget-content-area ecommerce-create-section">
                        <div class="row">
                            <div class="col-sm-12 mb-4">
                                ...
                                <input type="number" class="form-control" name="presupuesto" id="presupuesto" value="">
                            </div>
                            <div class="col-sm-12">
                                <button class="btn btn-success w-100" type="submit">Agregar Campaña</button>
                            </div>
                        </div>                                            
                    </div>
                </div>
