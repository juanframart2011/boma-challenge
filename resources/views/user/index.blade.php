                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink1" style="z-index:2;">
                                            ...
                                            @if( Crypt::decryptString( session( env( "APP_CODE" ) . 'r013' ) ) == 1 )
                                                <a class="dropdown-item btn-delete" data-id="{{ $user->id }}" data-name="{{ $user->name }}" href="#">Eliminar</a>
                                            @endif
                                        </div>
                                    </div>
                                </td>
...
@push('scripts')
    ...
    <script>
        productList = $('#user-list').DataTable({
        ...
        $( document ).ready( function(){
            ...
            $( document ).on( "click", ".btn-delete", function( event ){
                ...
                Swal.fire({
                    title: '¿Estas seguro de eliminar la usuario '+name+'?',
